...
##in this version of the any_t_extract code, we can get the halo positions at any time in the past, but the same Mv and rsize are assigned. 
...
def extract_time_rows(iniconf=None, suite_name = None, textract = None):
    ...
    summary_epoch = {"file_name":[], "xpos": [], "ypos" : [], "zpos": [],"vx":[],"vy":[],"vz":[], "Mvir": [], "M200c": [], "Mh": [], "Ms": [], "hdist": [], "rvir":[],"rs": [], "upID":[], "ID":[]}
    ...
    rel_columns = ["xpos","ypos","zpos","vx","vy","vz","M200c","Mh","Ms","hdist","Mvir", "rvir","rs","upID","ID"]
    ...
    summary_epoch_df["mV"] = np.array(summary_z0["mV"])
    summary_epoch_df["rsize"] = np.array(summary_z0["rsize"])
